...
const parseValue = () => {
  ...
  return (
    <div class="flex items-center gap-1">
      {props.label && (
        <span class="text-sm text-gray-600 mr-2">{props.label}</span>
      )}
      ...
      >
        <Select.Trigger class="w-16 flex items-center justify-between px-2 py-1.5 text-sm border border-gray-300 rounded-md bg-white hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed">
      ...
      >
        <Select.Trigger class="w-20 flex items-center justify-between px-2 py-1.5 text-sm border border-gray-300 rounded-md bg-white hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed">
          <Select.Value<string>>{(state) => state.selectedOption()}</Select.Value>
          <Select.Icon>▾</Select.Icon>
        </Select.Trigger>
        <Select.Portal>
